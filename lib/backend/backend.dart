...
import 'schema/meus_cartoes_record.dart';
import 'schema/esteira_de_pix_record.dart';
...
export 'schema/meus_cartoes_record.dart';
export 'schema/esteira_de_pix_record.dart';
...
/// Functions to query MeusCartoesRecords (as a Stream and as a Future).
Future<int> queryMeusCartoesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MeusCartoesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MeusCartoesRecord>> queryMeusCartoesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MeusCartoesRecord.collection,
      MeusCartoesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MeusCartoesRecord>> queryMeusCartoesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query EsteiraDePixRecords (as a Stream and as a Future).
Future<int> queryEsteiraDePixRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EsteiraDePixRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EsteiraDePixRecord>> queryEsteiraDePixRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EsteiraDePixRecord.collection,
      EsteiraDePixRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EsteiraDePixRecord>> queryEsteiraDePixRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
