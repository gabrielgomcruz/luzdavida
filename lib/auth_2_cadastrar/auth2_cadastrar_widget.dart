...
export 'auth2_cadastrar_model.dart';
...
class _Auth2CadastrarWidgetState extends State<Auth2CadastrarWidget>
    with TickerProviderStateMixin {
  late Auth2CadastrarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Auth2CadastrarModel());
