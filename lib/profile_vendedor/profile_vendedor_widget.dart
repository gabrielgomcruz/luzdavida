...
import 'profile_vendedor_model.dart';
export 'profile_vendedor_model.dart';
...
class _ProfileVendedorWidgetState extends State<ProfileVendedorWidget>
    with TickerProviderStateMixin {
  late ProfileVendedorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileVendedorModel());
